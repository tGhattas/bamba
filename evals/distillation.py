...
def distill_knowledge(teacher_model: AutoModelForCausalLM, student_model: Union[MambaLMHeadModel, AutoModelForCausalLM], optimizer: torch.optim.Optimizer,
    ...
    train_dataloader, eval_dataloader, teacher_model, student_model, optimizer = accelerator.prepare(train_dataloader, eval_dataloader, teacher_model, student_model, optimizer)
